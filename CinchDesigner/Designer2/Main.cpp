...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   hWnd = CreateWindow(L"CDWindow", szTitle, WS_OVERLAPPEDWINDOW,
	...
	HWND designer = CinchDesigner::CreateCinchDesigner(hWnd);

	SetWindowPos(designer, HWND_TOP, 0, 0, client.right, client.bottom, 0);
	ShowWindow(designer, nCmdShow);
